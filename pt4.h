...
{
    std::vector<T>::iterator p = cont.begin()
    if (p != cont.end())
    {
        Show(s, *p++);
        for (; p != cont.end(); ++p)
...
{
    for (std::vector<T>::iterator p = cont.begin(); p != cont.end(); ++p)
        Show(*p);
}
...
{
    std::deque<T>::iterator p = cont.begin()
    if (p != cont.end())
    {
        Show(s, *p++);
        for (; p != cont.end(); ++p)
...
{
    for (std::deque<T>::iterator p = cont.begin(); p != cont.end(); ++p)
        Show(*p);
}
...
{
    std::list<T>::iterator p = cont.begin()
    if (p != cont.end())
    {
        Show(s, *p++);
        for (; p != cont.end(); ++p)
...
{
    for (std::list<T>::iterator p = cont.begin(); p != cont.end(); ++p)
        Show(*p);
}
...
{
    std::set<T>::iterator p = cont.begin()
    if (p != cont.end())
    {
        Show(s, *p++);
        for (; p != cont.end(); ++p)
...
{
    for (std::set<T>::iterator p = cont.begin(); p != cont.end(); ++p)
        Show(*p);
}
...
{
    std::multiset<T>::iterator p = cont.begin()
    if (p != cont.end())
    {
        Show(s, *p++);
        for (; p != cont.end(); ++p)
...
{
    for (std::multiset<T>::iterator p = cont.begin(); p != cont.end(); ++p)
        Show(*p);
}
...
{
    std::map<T1, T2>::iterator p = cont.begin()
    if (p != cont.end())
    {
        Show(s, *p++);
        for (; p != cont.end(); ++p)
...
{
    for (std::map<T1, T2>::iterator p = cont.begin(); p != cont.end(); ++p)
        Show(*p);
}
...
{
    std::multimap<T1, T2>::iterator p = cont.begin()
    if (p != cont.end())
    {
        Show(s, *p++);
        for (; p != cont.end(); ++p)
...
{
    for (std::multimap<T1, T2>::iterator p = cont.begin(); p != cont.end(); ++p)
        Show(*p);
}
